#Failed, don't want to give combat a name and work it out from there. Maybe if we can keep combat the way it is?
import random
import time
import os
        ...
        if combatinput == "1":
            if current_enemy:
                ...
                if current_enemy.hp <= 0:
                    ...
                    if current_enemy.name == "slime" and Kill_Slimes < 7:
...
def game_loop():
    ...
    while True:
        ...
        #put the combatoption 1 in here
